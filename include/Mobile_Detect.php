...
class Mobile_Detect
{
	...
	public function supportsPositionFixed(){
		
		if(isset($_REQUEST["position_fixed"])){
			if($_REQUEST["position_fixed"] > 0){
				return true;
			}else{
				return false;
			}
	    ...
	    if(strpos($_SERVER['HTTP_USER_AGENT'], 'iPhone OS 5') !== false || strpos($_SERVER['HTTP_USER_AGENT'], 'OS 5') !== false){
	        return true;
	    }
